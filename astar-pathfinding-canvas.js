...
function createWorld() {
  ...
  pathStart = []; // Set your desired start point
  pathEnd = []; //

  currentPath = findPath(world, pathStart, pathEnd);
  redraw();
}
var pathMoveDelay = 100; // Adjust this value to control the speed of movement
      ...
      (function (index, num) {
        return function () {
          ctx.drawImage(
            ...
            tileWidth,
            tileHeight,
            currentPath[index][0] * tileWidth,
            currentPath[index][1] * tileHeight,
            tileWidth,
            tileHeight
          );
        };
